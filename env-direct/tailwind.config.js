  ...
  theme: {
    extend: {
      colors: {
        ...
        // Specialized Environment Colors
        forest: '#1a5d1a',
        ocean: '#006994',
        warning: '#ff6b35',
        success: '#4caf50',
      ...
      boxShadow: {
        'env': '0 10px 15px -3px rgba(20, 83, 45, 0.1), 0 4px 6px -2px rgba(20, 83, 45, 0.05)',
        'sea': '0 10px 15px -3px rgba(2, 119, 189, 0.1), 0 4px 6px -2px rgba(2, 119, 189, 0.05)',
        'glow-green': '0 0 15px rgba(34, 197, 94, 0.3)',
        'glow-blue': '0 0 15px rgba(59, 130, 246, 0.3)',
        'broadcast': '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
      },
    },
  },
  plugins: [
